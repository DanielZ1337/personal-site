...
export default {
	...
	text: {
		...
		skillsDescription2:
			'These are the experiences I have gained through projects in high school, university, and personal projects.',
		hello: 'Hello, my name is ',
		about:
			"I am a 22-year-old software engineer. Currently, I am pursuing a Bachelor's degree in Software Technology at the University of Southern Denmark and I am on my 5th semester.",
		...
		projectsDescription:
			'I am currently on my 5th semester at SDU, where I am studying software engineering. During this time, I have mostly worked with PostgreSQL and Java.',
		projectsDescription2:
			'I have been involved in several projects, both individually and collaboratively. I have experience with both frontend and backend development, as well as working with relational and non-relational databases.',
		projectsDescription3:
			'Additionally, I have also worked with Next.js and React, with Next.js being my primary experience with React. This work has been done using both JavaScript and TypeScript (best).',
		projectsDescription4:
			'I have also worked with C++ and have a good understanding of it. This was in connection with high school, where I took the Higher Technical Examination (HTX) (Mathematics A - Programming B).',
	...
	skills: [
		...
		},
		{
			title: 'C++',
			description:
				'During my high school education (Mathematics A - Programming B), I learned C++. Therefore, I have a solid understanding of C++.',
		...
		},
		{
			title: 'PostgreSQL',
			description:
				'PostgreSQL is the type of database I have the most experience with. It was our primary database at university, and I also used it for a project during high school.',
	...
	projects: [
		...
		},
		{
			...
			description:
				"This is a simple app that allows you to browse your GitHub repositories that have markdown files and view them. It's built with Next.js and uses the GitHub API to fetch data.",
			extraDescription: {
		...
		},
		{
			...
			description:
				"SMLinks is a website that allows you to create a profile that displays your social media links. It's built with Next.js and uses Redis to store data.",
        ...
        },*/
		{
			title: 'ValorVault',
			description:
				"ValorVault is a website that allows you to track your Valorant stats. It's built with Next.js and uses the Valorant API to fetch data.",
