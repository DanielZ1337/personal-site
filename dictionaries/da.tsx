...
export default {
    ...
    "text": {
        ...
        "about": "Jeg er en 22-årig softwareingeniør. Jeg studerer i øjeblikket Diplomingeniør i Software Teknologi på Syddansk Universitet og er på mit 5. semester.",
