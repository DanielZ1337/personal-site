  ...
  errors: {
    NotFound: {
      ...
      page: {
        ...
        message:
          "Du vil blive omdirigeret til forsiden, eller du kan trykke her for at gå til forsiden.",
      },
    },
  },
  navbar: {
  ...
  text: {
    ...
    contactform: {
      ...
      toast: {
        title: "E-mail sendt",
        description:
          "Din e-mail er blevet sendt. Jeg vil svare dig så hurtigt som muligt.",
      },
    },
    others: "Andre",
    ...
    skills: "Færdigheder",
    skillsDescription:
      "Her er nogle af de færdigheder, jeg har opnået gennem min uddannelse og projekter.",
    skillsDescription2:
      "Disse er de erfaringer, jeg har fået gennem projekter på gymnasiet, universitetet og fritidsprojekter.",
    hello: `Hej, mit navn er `,
    about:
      "Jeg er en 22-årig softwareingeniør. Jeg studerer i øjeblikket Diplomingeniør i Software Teknologi på Syddansk Universitet og er på mit 5. semester.",
    ...
    projectsDescription:
      "Går lige nu på 5. semester på SDU, hvor jeg læser til softwareingeniør. Her har jeg arbejdet mest med PostgreSQL og Java.",
    projectsDescription2:
      "Jeg har arbejdet på et par projekter, både alene og sammen med andre. Så har jeg også arbejdet med frontend og backend, samt med både relationelle og ikke-relationelle databaser.",
    projectsDescription3:
      "Derefter har jeg også arbejdet med Next.js og React, hvor Next.js har været min primære erfaring med React. Dette har været i JavaScript og TypeScript (bedst).",
    projectsDescription4:
      "Jeg har også arbejdet med C++ og har en god forståelse for det. Dette har været i forbindelse med gymnasiet, hvor jeg tog HTX (Matematik A - Programmering B).",
  ...
  skills: [
    {
      title: "React",
      description:
        "Next.js er bygget på react og er et framework til react; det er min primære erfaring med React",
      icon: <SiReact size={ICON_SIZE} />,
    },
    {
      title: "Next.js",
      description:
        "Har lavet et par projekter med Next.js, og har derfor erfaring med det",
      icon: <SiNextdotjs size={ICON_SIZE} />,
    },
    {
      title: "TypeScript",
      description:
        "Meste af hvad jeg laver er skrevet i TypeScript, da det gør tingene nemmere med type-safety",
      icon: <SiTypescript size={ICON_SIZE} />,
    },
    {
      title: "Java",
      description:
        "Har haft Java på universitetet i et par semestre, hvor jeg har scoret 12 i begge",
      icon: <DiJava size={ICON_SIZE} />,
    },
    {
      title: "C++",
      description:
        "Da jeg tog HTX (Matematik A - Programmering B), havde jeg C++ i gymnasiet. Så har en god forståelse for C++",
    ...
    },
    {
      title: "PostgreSQL",
      description:
        "PostgreSQL er den form for database, jeg har mest erfaring med. Det var vores primære database på universitetet, samt har selv brugt det tilbage i gymnasiet til et projekt",
    ...
    },
    {
      title: "Laravel",
      description:
        "Har arbejdet med Laravel i et par projekter, både på universitetet og arbejde",
  ...
  projects: [
    {
      ...
      description:
        "Denne hjemmeside er min personlige hjemmeside, hvor jeg fremviser mine projekter og færdigheder.",
    ...
    },
    {
      ...
      description:
        "Dette er en simpel app, der giver dig mulighed for at gennemse dine GitHub-repositorier, der har markdown-filer, og se dem. Den er bygget med Next.js og bruger GitHub API'en til at hente data.",
      extraDescription: {
    ...
    },
    {
      ...
      description:
        "Dette er en simpel app, der giver dig mulighed for at lave en profil og tilføje links til dine sociale medier. Den er bygget med Next.js og bruger Redis til at gemme data.",
        ...
        },*/
    {
      title: "ValorVault",
      description:
        "ValorVault er en hjemmeside, der giver dig mulighed for at følge dine Valorant-statistikker. Den er bygget med Next.js og bruger Valorant API'en til at hente data.",
