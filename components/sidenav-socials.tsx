...
export default function SideNavSocials() {
	...
	return (
		<m.div
			className={
				'h-[400px] w-[100px] fixed my-auto right-10 top-0 bottom-0 bg-muted rounded-xl break-all z-10 py-6 px-4 shadow-lg hidden lg:block'
			}
		...
		>
			...
			<div
				className={
					'flex flex-col gap-4 h-full justify-center items-center absolute left-0 right-0 bottom-0 top-14 m-auto'
				}
			>
				{Object.entries(socials).map(([key, value]) => (
					<Link
						...
						key={key}
						className={
							'flex justify-center items-center p-2 px-4 rounded-full hover:bg-primary hover:text-background text-primary text-2xl'
						}
						target='_blank'
						rel='noreferrer'
					>
