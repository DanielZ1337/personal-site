    ...
    return (
        ...
        >
            <div
                ...
                className={"mt-16 mb-16 flex max-w-[90vw] lg:max-w-[70vw] mx-auto bg-neutral-200 dark:bg-black rounded-xl py-14 px-10 md:py-20 md:px-16 flex-col h-full shadow-md"}>
                ...
                <div className={"mx-auto flex gap-2 w-full md:w-2/3 xl:w-1/2"}>
                    <div className={"whitespace-pre-wrap flex-wrap w-full"}>
                        <p className={"text-xl mb-5 md:mt-0 mt-16 dark:text-muted-foreground text-start"}>{dict.text.email}:{' '}
                            <span>
                        ...
                        <div className={"flex flex-col gap-4"}>
                            <SendEmailForm dict={dict} EMAILJS_SERVICE_ID={EMAILJS_SERVICE_ID} EMAILJS_TEMPLATE_ID={EMAILJS_TEMPLATE_ID} EMAILJS_PUBLIC_KEY={EMAILJS_PUBLIC_KEY}/>
                        </div>
                    </div>
                </div>
            </div>
