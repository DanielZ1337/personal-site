    ...
    return (
        ...
        >
            <div
                ...
                className={"mt-16 mb-16 flex md:max-w-[70vw] max-w-full w-full mx-auto bg-neutral-200 dark:bg-black rounded-xl py-24 px-20 flex-col h-full shadow-md"}>
                ...
                <div className={"mx-auto flex gap-2 w-1/2"}>
