...
export default async function ProjectBox({
	...
	return (
		<div className='flex flex-col gap-4 border border-primary/10 dark:border-border rounded-xl h-full p-4 bg-background shadow-md hover:shadow-lg transition-all'>
			<div className='flex justify-between items-center'>
				<Image
					...
					height={0}
					sizes={
						'(min-width: 1536px) 384px, (min-width: 1280px) 320px, (min-width: 1024px) 256px, (min-width: 768px) 384px, (min-width: 640px) 320px, 100vw'
					}
					style={{
						width: '100%',
						height: '100%',
			...
			<div className='flex flex-col gap-4 h-full justify-between'>
				<div>
					...
					>
						{title}
						<TbExternalLink className={'ml-2 mb-2 inline-block flex-shrink-0 flex-grow-0 text-primary'} />
