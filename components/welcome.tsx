...
export default function Welcome({ dict }: { dict: Dictionary }) {
	return (
		<div className={'h-[100dvh] z-10 mb-10 md:mb-0'}>
			<div
				className={
					'flex-1 flex-col flex items-center h-full my-40 bg-gradient-to-b from-background from-50% to-100% to-neutral-200 dark:to-black'
				}
			>
				<div>
					<div className={'relative md:w-96 md:h-96 w-64 h-64 drop-shadow-xl'}>
						...
						>
							...
							<div className={'absolute bottom-0 right-0 flex justify-center items-center'}>
								<Image
									src={logo}
									className={'absolute p-6 object-contain'}
									alt={siteConfig.title}
									width={200}
									height={200}
								/>
							...
							<div className={'absolute bottom-0 right-16 flex justify-center items-center'}>
								<NowPlaying />
							</div>
						</InViewWrapper>
					</div>
