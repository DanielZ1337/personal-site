    ...
    return (
        <div id={dict.navbar.links[0].projects.id} className={"bg-background min-h-screen relative"}>
            <div className={"mt-40 max-w-[90vw] lg:max-w-[70vw] mx-auto"}>
                ...
                <div
                    className={"grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 gap-4 mb-10 bg-neutral-200 dark:bg-black rounded-xl py-6 px-6 md:px-12 shadow shadow-md"}>
